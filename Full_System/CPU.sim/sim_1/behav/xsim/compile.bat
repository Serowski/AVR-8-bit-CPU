...
REM
REM Generated by Vivado on Sun Mar 29 22:58:01 +0200 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_sreg_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_sreg_vlog.prj -log xvlog.log
