...
module program_memory(
    ...
    input  logic [11:0] i_pc_addr,       // 4096 słów
    output logic [15:0] o_instruction,

    // PORT B - do zapisu przez UART
    input  logic [12:0] i_uart_addr,     // 8192 bajty
    input  logic [7:0]  i_uart_data,
    input  logic        i_uart_we        // Write Enable
);
    ...
    // Rozbijamy 13-bitowy adres z UART na dwie części:
